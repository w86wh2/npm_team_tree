            ...
            <div class="scroll-me">
                <div class="strt-wrap" id="strtWrap">
                    <ul class="strt-block">
                      ...
                      <span
                              class="nodeItem_title" :class="{'active':item._expand===2&&item.children.length}"
                              @click="changeStatus(trans_data,item,key)"
                              v-html="item.name"
                      >
                      </span>
                            <div class="line-v"><span></span></div>
                            <ul class="strt-block" v-if="item._expand===2">
                            ...
                            ></span>
                                    ...
                                    <span class="nodeItem normal"
                                          :class="{'active':item1._expand===2&&item1.children.length}"
                                          @click="changeStatus(item.children,item1,key1)"
                                          v-html="item1.name"
                                    >
                            </span>

                                    <div class="line-v" v-if="item1.children.length&&item1._expand===2"><span></span></div>
                                    <ul class="strt-block" v-if="item1._expand===2">
                                ...
                                ></span>
                                            <div class="line-v" ><span></span></div>
                                            <span class="nodeItem normal"
                                                  :class="{'active':item2._expand===2&&item2.children.length}"
                                                  @click="changeStatus(item1.children,item2,key2)"
                                                  v-html="item2.name"
                                            >
                                </span>
                                            <div class="line-v" v-if="item2.children.length&&item2._expand===2"><span></span></div>
                                            <ul class="strt-block" v-if="item2._expand===2">
                                    ...
                                    ></span>
                                                    <div class="line-v"><span></span></div>
                                                    <span class="nodeItem normal"
                                                          :class="{'active':item3._expand===2&&item3.children.length}"
                                                          @click="changeStatus(item2.children,item3,key3)"
                                                          v-html="item3.name"
                                                    >
                                    </span>
                                                    <div class="line-v" v-if="item3.children.length&&item3._expand===2"><span></span></div>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
